...
proxies = {
            "http": "http://lbrrlpbn-rotate:cq8wiq7w9k9g@p.webshare.io:80/",
        "https": "http://lbrrlpbn-rotate:cq8wiq7w9k9g@p.webshare.io:80/"
}
...
async def helpstr(message: types.Message):
    ...
    MSG = f'''
BIENVENIDOS AL CHECKER  {FIRST}, Im {BOT_NAME}


COMANDOS 
<a href="tg://user?id={OWNER}">HERE</a>
Cmds
/chk
/info
/bin'''
...
async def ch(message: types.Message):
    ...
    try:
        ...
        postdata = {
            ...
            "muid": Muid,
            "sid": Sid,
            "key": "pk_live_51McvlNC4Reh4hEaXdcAWINeBHpZ5Itiz4oDLJ63Di3y3a4p6ZCX0HgYJW0iHeWXuju5wxzKp9qXOv889LWVV0RfC00JS1rKKDM",
            "card[name]": Name,
            "card[number]": ccn,
            "card[exp_month]": mm,
            "card[exp_year]": yy,
